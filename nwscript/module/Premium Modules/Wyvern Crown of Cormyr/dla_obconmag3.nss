...
// Can be jewelry, wizardry, misc or clothing.  Usually level 3
...
//==========This section places treasure in the container
    int nRand = Random(20);
    if (nRand<9) GetTreasureType("Jewelry", OBJECT_SELF, 100, 3);
    else if (nRand<13)  GetTreasureType("Clothing", OBJECT_SELF, 100, 3);
    else if (nRand<18)  GetTreasureType("Misc", OBJECT_SELF, 100, 3);
    else if (nRand<20)  GetTreasureType("Wizardry", OBJECT_SELF, 100, 3);
