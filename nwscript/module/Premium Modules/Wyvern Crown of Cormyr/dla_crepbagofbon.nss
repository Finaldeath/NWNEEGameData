...
/*
  ...
  first time. This includes the option to throw a bag of bones
 */
//:://////////////////////////////////////////////////
...
//        SendMessageToPC(oPercep,"I SEE YOU");
        if(HasItem(OBJECT_SELF, "BagofBones"))
        {
            object oItem = GetFirstItemInInventory(OBJECT_SELF);
//            SendMessageToPC(oPercep,"I FIND BONES");
            if (GetTag(GetFirstItemInInventory(OBJECT_SELF))=="BagofBones")
            {
                if (Random(3) <2)
                {
//                SendMessageToPC(oPercep,"I THROW BONES");
                DestroyObject(oItem);
                ActionCastFakeSpellAtObject(SPELL_GRENADE_CALTROPS,GetFirstPC());
                DelayCommand(5.0,ExecuteScript("dla_miscbagofbon",OBJECT_SELF));
                }

            }
//            else SendMessageToPC(oPercep,"I CHECKED AND FOUND "+GetTag(oItem));
            }
        }
//*************************************************END OF ADDED CODE********************************
    else
