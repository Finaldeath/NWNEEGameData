...
// This one makes a key on the ground.
...
void main()
{
    ...
    { //It was a PC that entered the trigger - proceed.
        object oHolder = GetNearestObjectByTag("dla_spotobject"); //although it doesn't have to be a door!
        location lLoc = GetLocation(GetWaypointByTag("WP_FatherKey"));
        int nTest = GetLocalInt(oHolder, "OBJECT_SPOT");
        string sMessage = GetLocalString (oHolder,"OBJECT_MESSAGE");
...
//            FloatingTextStringOnCreature(sMessage,oPC);
            ...
            CreateObject(OBJECT_TYPE_ITEM,"keytfschest",lLoc,FALSE);
        }
