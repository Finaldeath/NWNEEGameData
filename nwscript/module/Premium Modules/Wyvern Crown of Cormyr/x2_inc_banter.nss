...
//:://////////////////////////////////////////////
// Last Modified By: Deva B. Winblood (DLA team) 5/3/2006
...
void AttemptInterjectionOrPopup(object oSelf, string sTag, object oTrigger, int nOverrideModNum=0, object oOverrideBanter=OBJECT_INVALID)
{
    // Modified By: Deva B. Winblood (DLA TEAM)  5/3/2006
    // ***********************
    ...
    if (GetLocalInt(GetModule(),"bInterjectionUsed_"+IntToString(MOD_EVENT_NUMBER)))
    { // already have done this interjection
      DestroyObject(oTrigger);
      return;
    } // already have done this interjection
    SetLocalInt(GetModule(),"bInterjectionUsed_"+IntToString(MOD_EVENT_NUMBER),TRUE);
