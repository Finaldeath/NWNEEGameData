...
// NOTE: This script does NOT apply to Jonas (see dla_creudfjonas created 1st May)
...
//              }
    ...
    {
        BeginConversation("Nyana2",OBJECT_SELF); //Nyana's leaving conversation
    }

    else if (nEvent == 20000 + ACTION_MODE_STEALTH)
    {
