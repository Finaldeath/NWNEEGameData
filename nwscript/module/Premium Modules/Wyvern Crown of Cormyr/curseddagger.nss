...
{
       if (GetTag(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,oPC))!=GetTag(oItem))//already equipped with a cursed dagger - do nothing
       {
        if (GetTag(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,oPC))=="Frostbrand")  AssignCommand(oPC,ActionEquipItem(oItem,INVENTORY_SLOT_LEFTHAND));
        else if (GetTag(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,oPC))=="CursedDagger")  AssignCommand(oPC,ActionEquipItem(oItem,INVENTORY_SLOT_LEFTHAND));
        else AssignCommand(oPC,ActionEquipItem(oItem,INVENTORY_SLOT_RIGHTHAND));
       }
}
