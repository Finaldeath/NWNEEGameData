   ...
   { case X2_ITEM_EVENT_EQUIP:  //Equip event for Deity Specific powers.
         {
            ...
            if (GetDeity(oPC)=="Silvanus") //check for a matching deity on the PC
            {
            //Deity Specific items generally give 2 or more powers, a 2/day power, and a temporary effect.
            itemproperty eProp = ItemPropertyCastSpell(IP_CONST_CASTSPELL_CAMOFLAGE_5,9);
            itemproperty eProp2 = ItemPropertyEnhancementBonus(2);
            itemproperty eProp3 = ItemPropertyCastSpell(IP_CONST_CASTSPELL_NEUTRALIZE_POISON_5,8);
                ...
                IPSafeAddItemProperty(oItem,eProp3,300.0);  //add the 'blessing' for 5 minutes
