...
{ switch( GetTagBasedItemEventNumber())
   {      case X2_ITEM_EVENT_ACTIVATE:
    ...
    if (GetIsObjectValid(oTarget))
        {
           FloatingTextStringOnCreature("Permanent 1 point bonus to dexterity",oPC,TRUE);
           IPSafeAddItemProperty(oTarget, ItemPropertyAbilityBonus(IP_CONST_ABILITY_DEX,1));
        }
    }
