   ...
   { case X2_ITEM_EVENT_EQUIP:  //Equip event for Deity Specific powers.
         {
            ...
            if (GetDeity(oPC)=="Selune") //check for a matching deity on the PC
            {
            //Deity Specific items generally give 2 or more powers, a 2/day power, and a temporary effect.
            itemproperty eProp = ItemPropertyCastSpell(IP_CONST_CASTSPELL_RESISTANCE_5,10);
            itemproperty eProp2 = ItemPropertyEnhancementBonus(2);
            itemproperty eProp3 = ItemPropertyCastSpell(IP_CONST_CASTSPELL_SILENCE_3,8);
