   ...
   { case X2_ITEM_EVENT_EQUIP:  //Equip event for Deity Specific powers.
         {
            ...
            if (GetDeity(oPC)=="Malar") //check for a matching deity on the PC
            {
            //Deity Specific items generally give 2 or more powers, a 2/day power, and a temporary effect.
            itemproperty eProp = ItemPropertyCastSpell(IP_CONST_CASTSPELL_BULLS_STRENGTH_10,9);
            itemproperty eProp2 = ItemPropertyAbilityBonus(IP_CONST_ABILITY_DEX,2);
