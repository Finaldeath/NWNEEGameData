...
// Get the PC, first.
    ...
    if (GetIsObjectValid(oTarget))
        {
           FloatingTextStringOnCreature("Permanent 2 point bonus to craft weapon",oPC,TRUE);
           IPSafeAddItemProperty(oTarget, ItemPropertySkillBonus(SKILL_CRAFT_WEAPON,2));
        }
    }
