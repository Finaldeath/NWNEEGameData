...
//November 2003
// B W-Husey
// PC has Taunt, and has not used it before.
// These generic scripts must ONLY be used once per character.
int StartingConditional()
{
    string sName = "TAUNT2"+GetTag(OBJECT_SELF);      //Set variable to object's tag
    ...
    if(!GetHasSkill(SKILL_TAUNT, GetPCSpeaker()) || (nOnce>0))
        return FALSE;
