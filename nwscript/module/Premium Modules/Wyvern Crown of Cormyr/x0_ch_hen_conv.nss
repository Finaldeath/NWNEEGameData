...
// added to prevent players from firing henchmen while in melee tournament
            if (GetTag(GetArea(OBJECT_SELF)) == "dla_mel_area" && nMatch == ASSOCIATE_COMMAND_LEAVEPARTY) return;
// end add
