...
// B W-Husey - added multiple henchmen command (set to 2 max)
...
void main()
{
   if (GetGameDifficulty() ==  GAME_DIFFICULTY_CORE_RULES || GetGameDifficulty() ==  GAME_DIFFICULTY_DIFFICULT)
   {
        ...
        //Vulc: June 12, 2006:  removed due to cloak build GetIsSkillSuccessful bug
   ...
   // SetModuleSwitch (MODULE_SWITCH_USE_XP2_RESTSYSTEM, TRUE);
    ...
    //Gale 19 April 2006: Setting this to a high number to avoid having problems
    //when loading a saved game. This is beging reseted to the correct number on
    //the function DLA_SetHenchman (dla_i0_horse), using the constant DLA_MAX_NPC_HENCHMEN,
    //from dla_i0_switches
    SetMaxHenchmen(10);
