/*
    ...
    returns TRUE if player has won and is last man standing
*/
...
/*
   ...
   PC has won his last fight and was last man standing, and he didn't talk
   to the Melee Master yet after winning.
*/
//:://////////////////////////////////////////////
//:: Create By: Gale
//:: Created On: Jan 11, 2006
//:: Modified: B W-Husey (companions token and last man standing check)
//:://////////////////////////////////////////////
/*
#include "dla_mel_inc"
...
int StartingConditional()
{
   ...
   int iResult = GetLocalInt(oPC , nMeleeOutcome) == 2 &&
                 ...
                 GetLocalInt(oPC, nLastManStand) == 1;
//   if (iResult)
