...
// Variation for trying to free the sword and failing.
...
// This is the 'correct' option for evil characters.
    AligXP("PolterAXP", oPC, "GOOD", 100, 0);        //Shift/reward any alignment
    AligXP("PolterAXP", oPC, "CHAOTIC", 25, 0);        //Shift/reward any alignment
    AligXP("PolterAXP", oPC, "NEUTRAL", 100, 0);        //Shift/reward any alignment

    ScoreAlign(oPC,3,3,3,3,3,3,3,2,1,0);            //Who gets alignment points for this - set in script s9 or s6
