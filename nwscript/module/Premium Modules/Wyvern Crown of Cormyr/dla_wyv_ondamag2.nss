...
/*
     ...
     When reach less than 10 hit points, it flies away
     Used on non-juveniles
*/
//:://////////////////////////////////////////////
//:: Created By: Gale
//:: Created On: 5 Feb 2006
//:: Modified by B W-Husey, 5th Feb
...
void main()
{
    ...
    if (GetCurrentHitPoints() < 10 && GetLocalInt(OBJECT_SELF,"nWontRun")<1 && GetIsMobile(OBJECT_SELF))
    {
        //Declare variables
        effect eDisap;
