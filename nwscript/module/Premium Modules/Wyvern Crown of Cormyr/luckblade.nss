   ...
   { case X2_ITEM_EVENT_EQUIP:  //Equip event for Deity Specific powers.
         {
            ...
            if (GetDeity(oPC)=="Tymora") //check for a matching deity on the PC
            {
            //Deity Specific items generally give 2 or more powers, a 2/day power, and a temporary effect.
            itemproperty eProp = ItemPropertyCastSpell(IP_CONST_CASTSPELL_HASTE_5,9);
            itemproperty eProp2 = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_UNIVERSAL,2);
