...
// Slight variant on 5, this one is slightly kinder to non-lawful good alignments as they turned down the money.
...
if (GetLocalInt(oPC,sName)<5) //once only
    ...
    ScoreAlign(oPC,5,0,3,4,1,3,5,3,4,4);            //Who gets alignment points for this
    }
