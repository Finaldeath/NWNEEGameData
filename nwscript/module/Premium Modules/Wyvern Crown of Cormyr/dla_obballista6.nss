...
// Change vOffset if you want to change the direction of fire.
// This one fires northeasterly with a shorter range and only bolts
...
void main()
{
    ...
    vector vOffset = Vector(30.0,30.0);
    ...
    object oTarget = GetFirstObjectInShape(SHAPE_SPELLCONE, 30.0, lOrigin ,TRUE,OBJECT_TYPE_CREATURE,vOrigin);
...
//       else
        ...
        ActionCastSpellAtObject(794, oTarget, METAMAGIC_ANY, TRUE, PROJECTILE_PATH_TYPE_DEFAULT);
