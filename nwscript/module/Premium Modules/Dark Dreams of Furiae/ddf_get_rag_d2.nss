...
void main()
{
    ...
    string sPaperTag = "rag_nspr_i2";// + IntToString(GetCurrentDay());
    ...
    SetName(oNewspaper, "Renegade Rag: Day 2");// + IntToString(GetCurrentDay()));
    SetLocalInt(oNewspaper, "DDF_CURRENT_DAY", 2);
