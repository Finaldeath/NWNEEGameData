...
void main()
{
    ...
    string sPaperTag = "rag_nspr_i6";// + IntToString(GetCurrentDay());
    ...
    SetName(oNewspaper, "Renegade Rag: Day 6");// + IntToString(GetCurrentDay()));
    SetLocalInt(oNewspaper, "DDF_CURRENT_DAY", 6);
