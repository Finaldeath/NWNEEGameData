...
//        DebugMessage("  Creating subprocess for area " + sAreaName);
        ...
        // create subprocess
        oMicroCPU = CreateObject(OBJECT_TYPE_PLACEABLE, "cpu", GetLocation(GetWaypointByTag("CPU")), FALSE, "MicroCPU54");
        SetLocalObject(oMicroCPU, "oArea", oArea);
        DelayCommand(0.01, ExecuteScript("exe_id1_catarea2", oMicroCPU));
