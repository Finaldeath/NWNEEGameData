...
//    DebugMessage("  Max CR is " + IntToString(nMaxCR));
    ...
    SetLocalInt(GetModule(), "bCreature" + IntToString(nCreature) + "Theme" + IntToString(nTheme), TRUE);
    SetLocalInt(GetModule(), "bTheme" + IntToString(nTheme) + "Creature" + IntToString(nCreature), TRUE);
...
/*
        if (bIntelligent == TRUE)
        {
            ...
            sCreature = sCR + "IntelligentCreature";
            nCreatureNum = GetLocalInt(GetModule(), sCreature);
            nCreatureNum++;
            SetLocalInt(GetModule(), sCreature, nCreatureNum);
...
//            DebugMessage("  Setting " + sCreature + " to " + IntToString(nCreature));
        } else
        {
            ...
            sCreature = sCR + "UnIntelligentCreature";
            nCreatureNum = GetLocalInt(GetModule(), sCreature);
            nCreatureNum++;
            SetLocalInt(GetModule(), sCreature, nCreatureNum);
...
//            DebugMessage("  Setting " + sCreature + " to " + IntToString(nCreature));
        ...
        if (bMediumSize == TRUE)
        {
            ...
            sCreature = sCR + "MediumSizeCreature";
            nCreatureNum = GetLocalInt(GetModule(), sCreature);
            nCreatureNum++;
            SetLocalInt(GetModule(), sCreature, nCreatureNum);
...
//            DebugMessage("  Setting " + sCreature + " to " + IntToString(nCreature));
            ...
            if (bIntelligent == TRUE)
            {
                ...
                sCreature = sCR + "IntelligentMediumSizeCreature";
                nCreatureNum = GetLocalInt(GetModule(), sCreature);
                nCreatureNum++;
                SetLocalInt(GetModule(), sCreature, nCreatureNum);
...
//                DebugMessage("  Setting " + sCreature + " to " + IntToString(nCreature));
            } else
            {
                ...
                sCreature = sCR + "UnIntelligentMediumSizeCreature";
                nCreatureNum = GetLocalInt(GetModule(), sCreature);
                nCreatureNum++;
                SetLocalInt(GetModule(), sCreature, nCreatureNum);
