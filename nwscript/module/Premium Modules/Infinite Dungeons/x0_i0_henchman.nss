...
void FireHenchman(object oPC, object oHench=OBJECT_SELF)
{
    ...
    string sConversation = GetLocalString(oHench, "sConversation");
    PrintString("Fired henchman sConversation is " + sConversation);
    if (sConversation == "id1_follower")
    {
        SetLocalString(oHench, "sConversation", "id1_hireling");
        SetLocalInt(oHench, "bFollower", FALSE);
    }
