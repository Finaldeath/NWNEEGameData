...
int StartingConditional()
{
    ...
    int nDungeonList = nDungeonNumber + ((nCurrentPage - 1) * 10);
    int nDungeon = GetLocalInt(OBJECT_SELF, "nDungeonList" + IntToString(nDungeonList));
    string sName = "Dungeon" + IntToString(nDungeon);
    DebugMessage("nDungeonList" + IntToString(nDungeonList) + " is " + sName);
    ...
    sString += "Deleting this dungeon will remove it from the game completely. Unless you have already exported this dungeon, all information will be lost.";

    SetCustomToken(5211, sString);
