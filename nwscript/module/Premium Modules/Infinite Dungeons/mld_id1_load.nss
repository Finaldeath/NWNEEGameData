...
//:://////////////////////////////////////////////////////////////
/*
    This is a copy of the HotU OnLoad script, not yet customized.
*/
//:://////////////////////////////////////////////////////////////
...
/*    if (GetModuleSwitchValue(MODULE_SWITCH_USE_XP2_RESTSYSTEM) == TRUE)
    ...
    // Update Dec 14, 2005: increase the number of possible henchmen
    SetMaxHenchmen(10);
    // Grant.

    // if this isn't from a saved game
    if (GetLocalInt(GetModule(), "bModuleCataloged") == FALSE)
    {
        SetLocalInt(GetModule(), "bModuleCataloged", TRUE);

        ExecuteScript("exe_id1_setup", GetModule());
    }

    // JE: Feb. 6, 2006
    // Set the default delay type for cutscenes to INCREMENTED.
    cs_SetDefaultDelayType(CS_DELAY_TYPE_INCREMENTED);
}
