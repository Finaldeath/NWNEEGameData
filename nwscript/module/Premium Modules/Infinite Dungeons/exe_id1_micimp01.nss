...
{
    DebugMessage("");
    DebugMessage("Importing open decor.");
    ...
    int nNum = GetLocalInt(oImport, "nListDecorOpenNum");
    ...
    {
        sResRef = GetLocalString(oImport, "sListDecorOpen" + IntToString(nImport) + "ResRef");
    ...
    } else
    {
        ...
        {
            object oMicroCPU = CreateObject(OBJECT_TYPE_PLACEABLE, "cpu", GetLocation(GetWaypointByTag("CPU")), FALSE, "MicroCPU73");
