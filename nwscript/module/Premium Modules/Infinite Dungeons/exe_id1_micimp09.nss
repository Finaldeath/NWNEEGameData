...
void main()
{
    ...
    {
        nMicroNum++;
        oMicroCPU = CreateObject(OBJECT_TYPE_PLACEABLE, "cpu", GetLocation(GetWaypointByTag("CPU")), FALSE, "MicroCPU81");
        ...
        DelayCommand(0.01, ExecuteScript("exe_id1_micimp14", oMicroCPU));
