...
void main()
{
    ...
    string sWaypoint = "Area" + IntToString(nAreaNum) + "WaypointSecretEncounter";
    ...
    DebugMessage("Spawning " + IntToString(nWaypointNum) + " secret encounter points.");
    ...
    while (nWaypoint <= nWaypointNum)
    {
        ...
        if (GetLocalInt(oDungeon, "b" + sLevel + "Used") == TRUE)
        {
            ...
            oWaypoint = GetLocalObject(oArea, "oWaypointSecretEncounter" + IntToString(nWaypoint));
