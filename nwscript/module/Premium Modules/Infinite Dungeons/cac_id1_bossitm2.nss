...
void main()
{
    ...
    if (oItem == OBJECT_INVALID)
    {
        ...
        {
            DebugMessage("Checking player " + GetTag(oPC) + " for " + sItemTag + "_dormant.");
        ...
        SendMessageToPC(GetPCSpeaker(), "Destroying plot quest item on " + GetName(oPC) + ".");
    }
    ...
    } else // if the item was found
    {
        ...
        if (oPC != GetPCSpeaker())
        {
            SendMessageToPC(GetPCSpeaker(), "Plot reward item placed on " + GetName(oPC) + ".");
        }
    }
    if (GetTag(oCreated) == "itm_id1_maggegg_active")
    {
    ...
    if (oItem2 == OBJECT_INVALID)
    {
        ...
        {
            DebugMessage("Checking player " + GetTag(oPC) + " for " + sItem2Tag);
        ...
        SendMessageToPC(GetPCSpeaker(), "Destroying plot item on " + GetName(oPC) + ".");
    }
    ...
    // April 4, 2006 GM: Award the players points for plot completion.
