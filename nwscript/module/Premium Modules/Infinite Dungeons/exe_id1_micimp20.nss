...
void main()
{
    ...
    while (nArea <= nAreaNum)
    {
        // exploration
        nMicroNum++;
        oMicroCPU = CreateObject(OBJECT_TYPE_PLACEABLE, "cpu", GetLocation(GetWaypointByTag("CPU")), FALSE, "MicroCPU86");
        ...
        DelayCommand(0.01, ExecuteScript("exe_id1_micimp24", oMicroCPU));
