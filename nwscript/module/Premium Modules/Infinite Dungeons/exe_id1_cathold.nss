...
void main()
{
    ...
    DebugMessage("");
    DebugMessage("Holding catalog with " + IntToString(nMicroNum) + " active and " + IntToString(nMicroDead) + " dead microprocesses.");
    ...
    } else // all microprocesses done
    {
        ...
        DebugMessage("Returning to exe_id1_catalog.");
