...
void main()
{
    ...
    {
        DebugMessage("  Creating linking information for tileset " + IntToString(nTileset));

        // create a subprocess to search for linkings for this tileset
        oMicroCPU = CreateObject(OBJECT_TYPE_PLACEABLE, "cpu", GetLocation(GetWaypointByTag("CPU")), FALSE, "MicroCPU57");
        ...
        DelayCommand(0.01, ExecuteScript("exe_id1_catlink2", oMicroCPU));
