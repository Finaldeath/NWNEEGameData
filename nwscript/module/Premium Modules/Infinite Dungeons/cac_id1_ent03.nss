...
void main()
{
    ...
    if (oDungeon != OBJECT_INVALID)
    {
        ...
        sString += "The current dungeon is " + sDungeonName + ".";
        ...
        } else
        {
            ...
            sString += " and " + GetLocalString(oDungeon, "sPrimaryTheme" + IntToString(nPrimary) + "Name") + ".";
        }
        sString = AddLineBreak(sString);
        ...
        } else
        {
            ...
            sString += " and " + GetLocalString(oDungeon, "sSecondaryTheme" + IntToString(nSecondary) + "Name") + ".";
        }
    } else
    {
        sString += "There is no dungeon currently selected.";
    }
