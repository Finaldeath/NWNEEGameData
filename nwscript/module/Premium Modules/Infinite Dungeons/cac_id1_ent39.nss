...
void main()
{
    ...
    // mage prefab
    SetLocalInt(GetModule(), "nPreset", 3);
    ...
    // categories
    SetModuleFlagValue(ID1_FLAG_CATEGORY_WEAPON_PERCENTAGE, 5);
    SetModuleFlagValue(ID1_FLAG_CATEGORY_ARMOR_PERCENTAGE, 5);
    SetModuleFlagValue(ID1_FLAG_CATEGORY_ACCESSORY_PERCENTAGE, 25);
    SetModuleFlagValue(ID1_FLAG_CATEGORY_CONSUMABLE_PERCENTAGE, 40);
    SetModuleFlagValue(ID1_FLAG_CATEGORY_MISCELLANEOUS_PERCENTAGE, 20);
    ...
    SetModuleFlagValue(ID1_FLAG_SUBCATEGORY_ARMOR_SHIELD_PERCENTAGE, 1);
    ...
    SetModuleFlagValue(ID1_FLAG_TYPE_DAGGER_PERCENTAGE, 36);
    ...
    SetModuleFlagValue(ID1_FLAG_TYPE_LONGSWORD_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_STAFF_PERCENTAGE, 36);
    SetModuleFlagValue(ID1_FLAG_TYPE_MORNINGSTAR_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_RAPIER_PERCENTAGE, 1);
    ...
    SetModuleFlagValue(ID1_FLAG_TYPE_SHORTSWORD_PERCENTAGE, 1);
    ...
    // ranged weapon types
    SetModuleFlagValue(ID1_FLAG_TYPE_DART_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_HEAVYCROSSBOW_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_LIGHTCROSSBOW_PERCENTAGE, 47);
    SetModuleFlagValue(ID1_FLAG_TYPE_LONGBOW_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_SHORTBOW_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_SHURIKEN_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_SLING_PERCENTAGE, 47);
    SetModuleFlagValue(ID1_FLAG_TYPE_THROWINGAXE_PERCENTAGE, 1);

    // ammunition weapon types
    SetModuleFlagValue(ID1_FLAG_TYPE_ARROW_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_BOLT_PERCENTAGE, 50);
    SetModuleFlagValue(ID1_FLAG_TYPE_BULLET_PERCENTAGE, 50);

    // armor body types
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_CLOTH_PERCENTAGE, 92);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_PADDED_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_LEATHER_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_HIDE_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_SCALE_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_CHAINMAIL_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_BANDED_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_HALFPLATE_PERCENTAGE, 1);
    SetModuleFlagValue(ID1_FLAG_TYPE_ARMOR_FULLPLATE_PERCENTAGE, 1);
    ...
    SetModuleFlagValue(ID1_FLAG_ENCOUNTER_FREQUENCY, 50);
    ...
    {
        SetModuleFlagValue(ID1_FLAG_ENCOUNTER_DIFFICULTY, -3);
        SetModuleFlag(ID1_FLAG_ENCOUNTER_SIZE, ID1_ENCOUNTER_SIZE_NORMAL);
    ...
    while (nValue <= 40)
    {
        oMicroCPU = CreateObject(OBJECT_TYPE_PLACEABLE, "cpu", GetLocation(GetWaypointByTag("CPU")), FALSE, "MicroCPU4");
