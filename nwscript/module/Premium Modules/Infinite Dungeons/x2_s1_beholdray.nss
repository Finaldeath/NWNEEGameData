...
void main()
{
    ...
    // Edit April 7, 2006 for Infinite Dungeons - Grant
    // The eye beam saving throw should now scale based on the caster level so
    // that beholder eye beams don't become completely worthless past level 20.
    ...
    // Debug information.
    DebugMessage("\n\nx2_s1_beholdray\n\n");
    DebugMessage("nHitDice = " + IntToString(nHitDice));
    DebugMessage("Target tag = " + GetTag(oTarget));
    // End edit.
