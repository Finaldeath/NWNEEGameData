//Kur-Tharsu doctor heals patient
    ...
    { // SpawnScriptDebugger();
        ...
        if(!GetHasEffect(EFFECT_TYPE_SLEEP)) {
            ...
            } else
            {
                ...
                if(GetLocalInt(OBJECT_SELF, "nPrayed") == 0)
                {
                    effect eVFX = EffectVisualEffect(VFX_IMP_SUPER_HEROISM);
                    SpeakString("Mighty Gruumsh! Take my body and use it to crush our enemies! For the horde!");
                    DelayCommand(1.0,
                    ...
                    DelayCommand(2.5, DetermineCombatRound());
                    SetLocalInt(OBJECT_SELF, "nPrayed", 1);
                }
                else
                {
                    DetermineCombatRound();
