...
/*
  ...
  to the world map area. SPECIAL CASE FOR WILD HILLS!
...
void main()
{
    ...
    // in wild hills area, if pc is going to world map,
    // reset ogre toll bridge variables if necessary
    if (GetLocalInt(oClicker, "nWH_PaidToll") == 1)  // paid toll
    {
        //SetLocalInt(oClicker, "nWH_PaidToll", 0);
    }
}
