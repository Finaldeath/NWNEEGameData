...
void SplitCreature(object oCreature, int iHP)
{
    string sOchre1 = "ochrejelly";
    string sOchre2 = "ochrejelly2";
    string sOchre3 = "ochrejelly3";
    string sOchre4 = "ochrejelly4";
    string sOchre5 = "ochrejelly5";
    ...
    if (sResRef == sOchre1)
    {
        oClone1 = CreateObject(OBJECT_TYPE_CREATURE, sOchre2, lSpawn, TRUE);
        oClone2 = CreateObject(OBJECT_TYPE_CREATURE, sOchre2, lSpawn, TRUE);
        iHitDice -= 1;
    }
    ...
    {
        oClone1 = CreateObject(OBJECT_TYPE_CREATURE, sOchre4, lSpawn, TRUE);
        oClone2 = CreateObject(OBJECT_TYPE_CREATURE, sOchre4, lSpawn, TRUE);
        iHitDice -= 3;
    }
