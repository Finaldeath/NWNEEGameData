...
{
    // spawn feldran
    object oWP = GetWaypointByTag("WP_AR2001_CUT1_FELDRAN");
    ...
    int i = 0;
    oWP = GetObjectByTag("WP_AR2001_CUT1_GUARD", i);
...
void start()
{
    ...
    TeleportToWaypoint(oPC, "WP_AR2001_CUT1_START", FALSE);
...
void next0(float fTime)
{
    ...
    {
        CutsceneCameraSetup(-1.0, DIRECTION_NORTH, 2.0, 85.0, CAMERA_TRANSITION_TYPE_SNAP);
        CutsceneNext(2.0);
    }
    else if (fTime == 2.0)
    {
