...
void main()
{
   ...
   SendMessageToPC(GetFirstPC(),IntToString(nEvent));
    ...
    else if (nEvent ==  X2_ITEM_EVENT_ACTIVATE)
    {
        ...
        object amulet = CreateObject(OBJECT_TYPE_PLACEABLE,"amuletoftesting",GetLocation(oPC));
        AssignCommand(oPC, ActionStartConversation(amulet,"amuletoftesting",FALSE,FALSE));
    }
