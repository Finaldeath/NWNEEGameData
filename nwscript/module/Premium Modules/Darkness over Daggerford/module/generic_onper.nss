//:://////////////////////////////////////////////////
//::
//:: Same as default except WalkWaypoints is commented out
//:: The WalkCondition NW_WALK_FLAG_CONSTANT can be set and
//:: unset(e.g. with events) to start and stop waypoint walking
//:: Dunno why default OnHeartbeat checks for this variable
//:: before walking waypoints, but default OnPerception does not.
//:: This script makes waypoint walking resume on heartbeat only.
//:://////////////////////////////////////////////////
