// player prepares to craft weapons/armor in the stronghold
...
{
    float fDur = 30.0;
    effect eBoost1 = EffectSkillIncrease(SKILL_CRAFT_ARMOR, 5);
    effect eBoost2 = EffectSkillIncrease(SKILL_CRAFT_WEAPON, 5);
    if (GetLocalInt(oPC, "nStrongholdCustomEffect") == 0)
    {
        ...
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eBoost2, oPC, fDur);
