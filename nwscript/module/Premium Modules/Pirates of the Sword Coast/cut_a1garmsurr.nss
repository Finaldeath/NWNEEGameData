...
//:://////////////////////////////////////////////
/*
    Garm surrenders in cutscene to the player
    after being defeated in the recent battle.
*/
//:://////////////////////////////////////////////
//:: Created By: Keith K2 Hayward
//:: Created On: July, 2004
//:://////////////////////////////////////////////
const string sShoutString = "Feassst well tonight, warmblood... Garm sssurrendersss!";
...
void main()
{
    ...
    DelayCommand(2.0f, AssignCommand(oGarm,
        PlayAnimation(ANIMATION_LOOPING_DEAD_BACK, 1.0f, 100.0f)));

    DelayCommand(3.5f, ApplyEffectToObject(DURATION_TYPE_PERMANENT, eFreeze, oGarm));
    DelayCommand(3.7f, AssignCommand(oPC, FadeFromBlack(oPC)));

    DelayCommand(4.5f, AssignCommand(oGarm, SpeakString(sShoutString)));
    DelayCommand(6.5f, AssignCommand(oClone, PlayAnimation(ANIMATION_FIREFORGET_VICTORY1)));
    DelayCommand(6.5f, AssignCommand(oClone, PlayVoiceChat(VOICE_CHAT_CHEER, oClone)));
