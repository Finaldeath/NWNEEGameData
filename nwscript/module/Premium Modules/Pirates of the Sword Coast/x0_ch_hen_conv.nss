...
const string S_NO_LEAVE = "Your loyal companion refuses to leave your side.";
...
//    SendMessageToPC(GetFirstPC(), IntToHexString(i));
    ...
    else
    {
        ...
        if (GetIsObjectValid(oMaster))
        {
            ...
            // K2 PotSC Hack to prevent the Henchmen from leaving the party.
            if (nMatch == ASSOCIATE_COMMAND_LEAVEPARTY)
            {
                FloatingTextStringOnCreature(S_NO_LEAVE, oShouter);
                return;
            }
