//::///////////////////////////////////////////////
//:: PotSC - Henchman Popup Trigger: A2_WILLIGANS
//:: ten_pop_willigan.nss
...
void main()
{
    ...
    object oLadder = GetNearestObjectByTag("a2_wwladder");

    //Only fire if Willigan's rum-running ladder is present.
    if (GetIsObjectValid(oLadder) == TRUE)
    {
        //Check the DoOnce
        if (bFireOnce == FALSE)
        {
