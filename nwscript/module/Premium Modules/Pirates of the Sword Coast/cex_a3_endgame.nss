...
//:://////////////////////////////////////////////
/*
    End the game and store variables to DB.
*/
//:://////////////////////////////////////////////
...
void main()
{
    object oTarget = GetObjectByTag("A3_FNL_PCCOPY1");
    object oPath = GetObjectByTag("A3_FNL_FOLLOWER5_0");
    object oArea = GetArea(oTarget);

    cs_SetDelayType(CS_DELAY_TYPE_TOTAL, oArea);

    cs_CameraUseCameraWaypoint(1.0, 6, FALSE, oArea);
    AssignCommand(OBJECT_SELF,StoreIt());
    effect e = EffectVisualEffect(VFX_FNF_UNDEAD_DRAGON);
    DelayCommand(4.0, ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, e, GetLocation(oTarget)));

    cs_CameraDoFade(6.0, CS_FADE_TYPE_TO_BLACK, FADE_SPEED_SLOWEST, oArea);
    DelayCommand(12.0, PlayTheMovie());
