...
void main()
{
    ...
    {
        if ((GetTag(oTarget) == "a3_monster")
          || (GetTag(oTarget) == "a3_tashag")
          || (GetTag(oTarget) == "a3_clrchrpy"))
        {
            DoGrenade(d8(2)+8,1, VFX_IMP_FLAME_M, VFX_FNF_FIREBALL, DAMAGE_TYPE_FIRE, RADIUS_SIZE_HUGE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
        }
        else
        {
