...
void main()
{
    ...
    */
    ...
    // K2 - Hack to support making torches with this spell for POTSC
   ...
   if(GetIsObjectValid(oMyWeapon) )
   {
        ...
        // K2 - Hack to support making torches with this spell for POTSC
        if (GetTag(oMyWeapon) == "a1_stick")
        {
            DestroyObject(oMyWeapon);
            CreateItemOnObject("a1_torch", OBJECT_SELF);
            ExecuteScript("exe_a1_surviv40", OBJECT_SELF);
        ...
        else if (GetTag(oMyWeapon) == "a1_stick_long")
        {
            DestroyObject(oMyWeapon);
            CreateItemOnObject("a1_torch_long", OBJECT_SELF);
            ExecuteScript("exe_a1_surviv40", OBJECT_SELF);
