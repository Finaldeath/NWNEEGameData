...
void main()
{
    ...
    location lObject = GetLocation(oTile);
    ...
    if (iSubColor == COLOR_RED)
    {
        ...
        oArrow = CreateObject(OBJECT_TYPE_PLACEABLE, "a2puz_redarrow", lObject);
    }
    else if (iSubColor == COLOR_GREEN)
    {
        ...
        oArrow = CreateObject(OBJECT_TYPE_PLACEABLE, "a2puz_grnarrow", lObject);
    }
    else if (iSubColor == COLOR_BLUE)
    {
        ...
        oArrow = CreateObject(OBJECT_TYPE_PLACEABLE, "a2puz_bluarrow", lObject);
    }
